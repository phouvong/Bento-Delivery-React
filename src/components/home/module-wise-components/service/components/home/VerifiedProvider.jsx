...
const VerifiedProvider = ({ title, subtitle }) => {
  ...
  const sliderSettings = {
    ...
    responsive: [
      ...
      {
        breakpoint: 480,
        settings: { slidesToShow: 1.4, slidesToScroll: 1, swipeToSlide: true },
      },
      {
        breakpoint: 340,
        settings: { slidesToShow: 1.2, slidesToScroll: 1, swipeToSlide: true },
      },
    ],
  };
