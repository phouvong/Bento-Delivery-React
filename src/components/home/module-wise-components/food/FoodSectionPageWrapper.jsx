...
const FOOD_BANNER_TITLES = {
  Offers: "Search Delicious Offers",
  "Free Delivery": "Find Free Delivery Food",
  "Top Rated": "Search Top Rated Restaurants",
  Nearby: "Search Nearby Restaurants",
  "Express Delivery": "Search Express Delivery Food",
};

const FoodSectionPageWrapper = ({ sectionLabel, enableSearch = true, childHandlesSearch = false, children }) => {
  ...
  const filterButton = enableSearch ? (
    ...
    >
      ...
      {appliedFilterCount > 0 && (
        ...
        >
          <Typography sx={{ fontSize: "11px", fontWeight: 700, color: "#fff", lineHeight: 1 }}>
            {appliedFilterCount}
          </Typography>
        </Box>
      )}
  ...
  return (
    <>
      ...
      <ModuleSectionPageWrapper
        ...
        bannerTitle={FOOD_BANNER_TITLES[sectionLabel] ?? "Search Delicious Food"}
        bannerSubtitle="Easy search to easy order & get fast delivery for your need."
        searchComponent={
          enableSearch
            ? <SectionSearchBar placeholder={t("Search Here...")} />
            : undefined
        }
...
export default FoodSectionPageWrapper;
