export const lao = {
  ...
  "For the love of delicious food.": "ດ້ວຍການຄົ້ນຫາອາຫານແຊບໆທີ່ທ່ານມັກ.",
  ...
  "Are you sure to change the language?":
    "ທ່ານໝັ້ນໃຈບໍ່ວ່າຢາກປ່ຽນພາສາ?",
  "The browser will refresh to get translated content.":
    "ບຣາວເຊີ້ຂອງທ່ານຈະໂຫຼດຄືນເພື່ອດຶງຂໍ້ມູນພາສານັ້ນ.",
  No: "No",
  ...
  "Search foods and restaurants...": "ຄົ້ນຫາອາຫານ ແລະຮ້ານອາຫານ...",
  "Wanna Try  Again!": "ຕ້ອງການສັ່ງຊື້ອິກຄັ້ງບໍ່!",
  "Get your recent food from the restaurant you recently visited":
    "ສັ່ງອາຫານຄືນທີ່ທ່ານເຄີຍສັ່ງຈາກຮ້ານທີ່ທ່ານເຄີຍສັ່ງຜ່ານມາກ່ອນ",
